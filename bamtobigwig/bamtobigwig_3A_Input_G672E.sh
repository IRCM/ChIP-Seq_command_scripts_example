...
#PBS -V
#PBS -N_sorted_by_coordinates.bamtobigwig_3A_Input_G672E.sh
#PBS -q sw
#PBS -A afb-431-ac
...
1> ../../bedgraph/before_normalisation/3A_Input_G672E.bedgraph

bedGraphToBigWig \
../../bedgraph/before_normalisation/3A_Input_G672E.bedgraph \
/sb/project/afb-431/genomes//Homo_sapiens/UCSC/hg19/Annotation/Genes/ChromInfo.txt \
../../bigwig/before_normalisation/3A_Input_G672E.bw
