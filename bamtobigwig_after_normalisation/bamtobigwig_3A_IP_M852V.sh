...
#PBS -V
#PBS -N bamtobigwig_3A_IP_M852V.sh
#PBS -q sw
#PBS -A afb-431-ac
...
1> ../../bedgraph/after_normalisation/3A_IP_M852V.bedgraph

bedGraphToBigWig \
../../bedgraph/after_normalisation/3A_IP_M852V.bedgraph \
/sb/project/afb-431/genomes//Homo_sapiens/UCSC/hg19/Annotation/Genes/ChromInfo.txt \
../../bigwig/after_normalisation/3A_IP_M852V.bw
