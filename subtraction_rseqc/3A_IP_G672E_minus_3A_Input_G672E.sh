...
--min_signal=5 \
--bwfile1=../../bigwig/after_normalisation/3A_IP_G672E.bw \
--bwfile2=../../bigwig/after_normalisation/3A_Input_G672E.bw \
--output=../../bigwig/subtraction/3A_IP_G672E_minus_3A_Input_G672E.bw
